...
LevelAnimation.prototype.animateBombs = function(layer){
	...
	function animateBomb(callback){
		...
		switch( randomBombId ) {
			case 1:
				image = LoadingScreen.gal.get(MapScreen.GAL_PREFIX + 'bomb-left-one-strip.png');
				bombImageSpriteSheet = new SpriteSheet(image, LevelAnimation.BOMB_1_SPRITE_MATRIX,2); 
				coordinates = [556, 255 - image.height];
				break;
			case 2:
				image = LoadingScreen.gal.get(MapScreen.GAL_PREFIX + 'bomb-left-two-strip.png');
				bombImageSpriteSheet = new SpriteSheet(image, LevelAnimation.BOMB_2_SPRITE_MATRIX,2); 
				coordinates = [546, 245 - image.height];
				break;
			case 3:
				image = LoadingScreen.gal.get(MapScreen.GAL_PREFIX + 'bomb-mid-strip.png');
				bombImageSpriteSheet = new SpriteSheet(image, LevelAnimation.BOMB_3_SPRITE_MATRIX,2); 
				coordinates = [715, 336 - image.height];
				break;
			case 4:
				image = LoadingScreen.gal.get(MapScreen.GAL_PREFIX + 'bomb-right-strip.png');
				bombImageSpriteSheet = new SpriteSheet(image, LevelAnimation.BOMB_4_SPRITE_MATRIX); 
				coordinates = [744 , 245 - image.height];
				break;
		} //switch( randomBombId ) {
...
LevelAnimation.prototype.animateGameStartArrow = function(layer){
	...
	function animateGameStartArrow(){
		...
		image = LoadingScreen.gal.get(MapScreen.GAL_PREFIX + 'start-arrow-strip.png');
